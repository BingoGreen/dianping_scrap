...
class Shenzhen(scrapy.Spider):
    ...
    def start_requests(self):
        ...
        yield Request('http://www.dianping.com/shenzhen/food', meta={'cityName': 'Shenzhen'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/beijing/food', meta={'cityName': 'Beijing'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/shanghai/food', meta={'cityName': 'Shanghai'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/guangzhou/food', meta={'cityName': 'Guangzhou'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/chengdu/food', meta={'cityName': 'Chengdu'}, cookies=cookies,
                      callback=self.parse)
        #yield Request('http://www.dianping.com/qingdao/food', meta={'cityName': 'Qingdao'}, cookies=cookies,
         #             callback=self.parse)
        #yield Request('http://www.dianping.com/jinan/food', meta={'cityName': 'Jinan'}, cookies=cookies,
        #              callback=self.parse)
        yield Request('http://www.dianping.com/nanjing/food', meta={'cityName': 'Nanjing'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/suzhou/food', meta={'cityName': 'Suzhou'}, cookies=cookies,
                      callback=self.parse)
        yield Request('http://www.dianping.com/hangzhou/food', meta={'cityName': 'Hangzhou'}, cookies=cookies,
                      callback=self.parse)
        #yield Request('http://www.dianping.com/xiamen/food', meta={'cityName': 'Xiamen'}, cookies=cookies,
        #              callback=self.parse)
        #yield Request('http://www.dianping.com/changsha/food', meta={'cityName': 'Changsha'}, cookies=cookies,
         #             callback=self.parse)
        #yield Request('http://www.dianping.com/hefei/food', meta={'cityName': 'Hefei'}, cookies=cookies,
         #             callback=self.parse)
